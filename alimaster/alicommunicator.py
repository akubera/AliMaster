...
class AliCommunicator():
    """
    The AliCommunicator provides a simple interface for sending and retrieving
    messages to the ALICE grid.
    """
    ...
    def run(self, args):
        ...
        create = asyncio.create_subprocess_exec(*args, stdout=PIPE)
