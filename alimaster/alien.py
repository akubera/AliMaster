...
class Alien:
    ...
    def __init__(self):
        self.cnx = None
        self.loop = None
        self.is_connected = lambda: self.cnx is not None
    ...
    def connect(self, username=''):
        ...
        def _do_connection():
            ...
            import ROOT
            err_str = "ROOT does not appear to have 'AliEn'"
            assert hasattr(ROOT, 'TAlien'), err_str
            # self.cnx = ROOT.TGrid.Connect("alien://aliendb4.cern.ch:9000",
            #                               username,
            #                               0,
            #                               "-debug=1"
            #                               )
    ...
    def start(self):
        ...
        self.root_process = Process(target=self.start_root_process,
